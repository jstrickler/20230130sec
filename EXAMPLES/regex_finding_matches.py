...
s = """K-12 orem ipsum M-302 dolor sit amet, consectetur r-99 adipiscing elit, sed do
...
pattern = r'.{0,20}[A-Z]-\d{2,3}.{0,20}'  # store pattern in raw string
...
print(m)
if m:
    print("Found:", m.group(0), m.start(0), m.end(0))  # group(0) returns text that was matched by entire expression (or just m.group())
print()
